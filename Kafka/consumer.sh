...
/usr/hdp/current/kafka-broker/bin/kafka-console-consumer.sh --bootstrap-server $brokers --consumer-property security.protocol=SASL_PLAINTEXT --topic dsti_2020_fall_1
